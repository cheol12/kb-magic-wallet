    ...
    <div class="center">
        <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
                <h3 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">환전/</span> 온라인</h3>
                <!-- Basic Layout -->
                <form action="${pageContext.request.contextPath}/exchange/online/form" method="post" id="exchangeOnlineForm">
                    <div class="row">
                        <div class="col-xl">
                            <div class="card mb-4">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="row gx-3 gy-2 align-items-center">
                                        ...
                                        <div class="col-mb-3">
                                            <button type="button" class="btn btn-primary" onclick="balanceCK();">잔액 조회</button>
                                        </div>
                                        <div>
