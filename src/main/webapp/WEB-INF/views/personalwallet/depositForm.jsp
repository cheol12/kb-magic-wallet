    ...
    <div class="center">
        <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
                <h2 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">개인지갑/</span> 충전</h2>
                <!-- Basic Layout -->
                                ...
                                <div class="card-body">
                                    <div class="row gx-3 gy-2 align-items-center">
                                        ...
                                        <h5 class="mb-3">
                                            ...
                                            <div class="mb-3">
                                                <button type="button" class="btn btn-outline-warning" style="font-size: 0.875rem;" onclick="addValue(10000)">1만</button>
                                                <button type="button" class="btn btn-outline-warning" style="font-size: 0.875rem;" onclick="addValue(30000)">3만</button>
                                                <button type="button" class="btn btn-outline-warning" style="font-size: 0.875rem;" onclick="addValue(50000)">5만</button>
                                                <button type="button" class="btn btn-outline-warning" style="font-size: 0.875rem;" onclick="addValue(100000)">10만</button>
                                                <button type="button" class="btn btn-outline-warning" style="font-size: 0.875rem;" onclick="addValue(500000)">50만</button>
                                                <button type="button" class="btn btn-outline-warning" style="font-size: 0.875rem;" onclick="addValue(1000000)">100만</button>
                                            </div>
                                        </h5>
                                        <div class="mb-3">
                                            <h5>
